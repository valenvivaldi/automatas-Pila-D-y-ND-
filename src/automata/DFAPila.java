...
public State delta(State from, Character c){
        ...
        while ((quintupleCompatible ==null )&&iterator.hasNext()) {
        		...
        		if (quintupleCandidato.first().equals(from)&&quintupleCandidato.second().equals(c)&&(quintupleCandidato.third().equals(this.stack.peek())||quintupleCandidato.third().equals(Joker))  ) {
        ...
        if(quintupleCompatible != null) {
        	...
        	stack.pop();
                ...
                String stringParaApilar =quintupleCompatible.fourth();
                ...
                return quintupleCompatible.fifth();
        }
